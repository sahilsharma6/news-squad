        ...
        <div className="flex py-8 gap-5">
          <article className="text-left w-3/4">
            <p className="leading-relaxed py-2">
              ...
              headed down to our homestay family’s small dining room for
              breakfast.
            </p>

            <h3 className="leading-relaxed py-2">
              Refreshingly, what was expected of her was the same thing that was
              expected of Lara Stone: to take a beautiful picture.
            </h3>

            <p className="leading-relaxed py-2">
              We were making our way to the Rila Mountains, where we were
              visiting the Rila Monastery where we enjoyed scrambled eggs,
              toast, mekitsi, local jam and peppermint tea
            </p>

            <img src={img1} alt="" className="w-full mt-7" />
            <caption className="w-full text-left text-sm py-1">
              Adderall and flirting with bulimia in an attempt to whittle
              herself
            </caption>

            <p className="leading-relaxed py-2">
              We wandered the site with busloads of other tourists, yet
              strangely the place did not seem crowded. I’m not sure if it was
              the sheer size of the place, or whether the masses congregated in
              one area and didn’t venture far from the main church, but I didn’t
              feel overwhelmed by tourists in the monastery.
            </p>
            ...
            <div className="flex gap-1">
              <aside className="leading-loose">
                <p>
                  {" "}
                  We wandered the site with busloads of other tourists, yet
                  strangely the place did not seem crowded. I’m not sure if it
                  was the sheer size of the place, or whether the masses
                  congregated in one area and didn’t venture far from the main
                  church, but I didn’t feel overwhelmed by tourists in the
                  monastery.
                </p>

                <p>
                  Feeling refreshed after an espresso, we walked a short
                  distance to the small but welcoming Banya Bashi Mosque, then
                  descended into the ancient Serdica complex.
                </p>

                <p>
                  We were exhausted after a long day of travel, so we headed
                  back to the hotel and crashed.
                </p>

                <p>
                  {" "}
                  I had low expectations about Sofia as a city, but after the
                  walking tour I absolutely loved the place. This was an easy
                  city to navigate, and it was a beautiful city – despite its
                  ugly, staunch and stolid communist-built surrounds. Sofia has
                  a very average facade as you enter the city, but once you lose
              ...
              <img
                src={img2}
                alt=""
                className="object-cover max-h-96 max-w-52"
              />
            </div>
          </article>
          <div className="text-left px-10">
            <div>
              <div className="border-b-2 py-1 border-black">
                <span className="bg-black text-white uppercase px-3 py-2 w-1/4 ">
                  most popular
                </span>
              </div>
              <div className="py-5">
                ...
                <ul className="space-y-6">
                  ...
                  <li className="flex gap-3  items-center space-y-4 md:space-y-0 md:space-x-4">
                    ...
                    <div>
                      <h4 className="hover:text-blue-500">
                        Game Changing Virtual Reality Console
                      </h4>
                      <p className="text-sm text-gray-400">August 7, 2019</p>
                    </div>
                  </li>
                  ...
                  <li className="text-center">
                    <button className="p-2 border text-center text-sm mx-auto">
                      {" "}
                      Load more{" "}
                    </button>
                  </li>
              ...
              <div>
                <div className="border-b-2 py-1 border-black">
                  <span className="bg-black text-white uppercase px-3 py-2 w-1/3 ">
                    recent comments
                  </span>
                </div>
                <div className="py-5">
